...
# ===== CONFIG =====
TOKEN = os.getenv("DISCORD_TOKEN")  # from Railway Variables
CHANNEL_ID = 1419941517103075454    # your Discord channel ID
RSS_URL = "https://rss.app/feeds/Rja0GFPWPIz5ZQNG.xml"  # your RSS feed
    ...
    while True:
        ...
        if feed.entries:
            ...
            if post_id != last_post_id:
                ...
                # Optional: if the RSS has images
